...
<div class="row channels">
    ...
    <div
        ...
        <h5 class="channel_title">
            <img class="logo" src="/storage/{{ $channel->logo_path }}"> <a
                ...
                <img src="/storage/images/{{$favour_set['picture']}}.png"
                    class="favour_image img_id{{ $channel->channel_id }}">@if(Auth::check()) <a
        ...
        <div class="current">
            ...
            <a href="#" id="{{ $programCurrent->id }}" class="load_description" data-toggle="modal"
                data-target="#basicModal" onClick="description(this);">{{$programCurrent['name']}}</a> @else
