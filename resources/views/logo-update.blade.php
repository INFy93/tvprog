...
<div class="col-12">
    ...
    <form action="{{ route('logo_update', $logo_single->channel_id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="form-group">
            <label for="logo">Выберите логотип (в формате <strong>jpg</strong>, <strong>png</strong>,
    ...
    <br>
    <a href="{{ route('logo_show') }}"><button type="submit" class="btn btn-success">Вернуться к просмотру
            логотипов</button></a>
</div>
