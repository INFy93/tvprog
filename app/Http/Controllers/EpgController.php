...
class EpgController extends Controller
{
    ...
    { //получаем описание программы (для ajax)
    ...
    public function getDescrCurrent($id)
    { //получаем описание программы с картинкой (для ajax)
        $descr = Epg::leftJoin('itv', function ($join) {
